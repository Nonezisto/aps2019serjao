...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-12">
            <h2 class="text-center">Editar estagiário</h2>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <textarea class="form-control" style="height:150px" name="detail" placeholder="Descrição do estágio">{{ $student->detail }}</textarea>
                </div>
            </div>
